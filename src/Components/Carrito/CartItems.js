  ...
  return (
    <div className="">
      <table className="w-full table-fixed">
        ...
        <tr>
          <td className=" border-y-4 text-slate-100" ><h4> {name} </h4></td>
          <td className=" border-y-4 text-slate-100 w-1/2" ><h5> ${price}.00 x {quantity} </h5></td>
          <td className=" border-y-4 text-slate-100 w-1/2"><h5> ${price * quantity}.00 </h5></td>
        </tr>
