...
const Contacto = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-orange-600">
      <div className="mt-12 mb-10 w-2/3 p-20 bg-gray-800 rounded shadow-2xl">
        ...
        <form className="space-y-3">
          ...
          <div>
            <label className="w-full block mb-1 font-bold text-gray-500">Mensaje</label>
            <input
              type="Mensaje"
          ...
          <button className="w-full block  p-4 text-black transition duration-300 bg-orange-400 rounded hover:bg-orange-300 hover:text-yellow-800">
            Enviar
          </button>
        </form>
      </div>
